                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <form method="POST" action="{{route('updateAppointment', $appointment->id)}}">
                                @csrf
                                @method('PUT')
                                <!-- Name -->

                                <diV>
                                    <label for="roles" class="mb-2">Select a doctor</label>
                                    <select id="roles" class="  block w-full p-2.5" name="doctor_id">
