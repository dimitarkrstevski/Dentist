                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <form method="POST" action="{{route('updatePrice', $price->id)}}">
                                @csrf
                                @method('PUT')
                                <!-- Name -->
                                <div>
                                    ...
                                    <x-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$price->name}}"   />
                                    <div class="row mb-4">
                                        @error('name')
                                ...
                                <div>
                                    ...
                                    <x-input id="description" class="block mt-1 w-full" type="text" name="description" value="{{$price->description}}"   />
                                    <div class="row mb-4">
                                        @error('description')
                                        <span class="text-red-700"> {{ $message }}</span>
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <x-input id="price" class="block mt-1 w-full" type="number" name="price" value="{{$price->price}}"   />
                                    <div class="row mb-4">
                                        @error('price')
                                        <span class="text-red-700"> {{ $message }}</span>
                                        @enderror
